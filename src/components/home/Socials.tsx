			...
			<div className="max-w-7xl mx-auto px-4">
				<div className="text-center mb-12">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						Ijtimoiy tarmoqlarimizda yangiliklar va foydali ma'lumotlardan
						xabardor bo'ling
					</p>
				</div>
						...
						return (
							...
							>
								<Card className="h-full hover:shadow-xl transition-all duration-300 border-none overflow-hidden hover:-translate-y-1">
									<div
										className={`h-2 bg-gradient-to-r ${social.color}`}
									/>
									<CardContent className="pt-6 pb-6 text-center">
										<div
											className={`w-14 h-14 mx-auto mb-4 bg-gradient-to-r ${social.color} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
										>
