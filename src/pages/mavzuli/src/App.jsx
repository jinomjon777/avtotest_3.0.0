...
function App() {
  ...
  useEffect(() => {
    async function loadTopics() {
      try {
        ...
        const topics = [
          { id: '32', name: 'Yangi Savollar' }, // faqat supabase
          ...
          { id: '33', name: 'Tartibga solinmagan chorrahada asosiy yo\'l', filename: '33.json' },
  ...
  const loadQuestionsFromSupabase = async () => {
    ...
    console.log('Supabase questions:', questions);
    console.log('Supabase choices:', choices);
